...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    KC_LSHIFT,KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMMA, KC_DOT, KC_SLASH, KC_ESC, KC_FN,
    KC_LALT,  KC_LGUI, KC_SPACE, KC_LANG1, KC_SPACE, KC_RGUI, KC_RALT
  ),
  [_FN] = LAYOUT(
    ...
    _______, _______, _______, KC_LANG2, _______, KC_STOP, RESET
  )
};
